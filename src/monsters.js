...
export var gridBug =          { difficulty: 1, glyph: {key: 'x', fg: 'purple'}, spawnPattern: '1d2',
                                  attributes: {ac: -1, speed: 150, level: 1, str: 3, dex: 3, con: 0, killXp: '4d1', spawnHp: '1d4 + 2'}, 
                                  stats: {name: 'grid bug',
...
export var jackal =           { difficulty: 2, glyph: {key: 'd', fg: 'brown'}, spawnPattern: '1d3 + 1',
                                  attributes: {ac: -3, speed: 125, level: 1, str: '1d2 + 4', dex: 3, con: 2, killXp: '2d3 + 3', spawnHp: '1d5 + 5', gold: '1d10'}, 
                                  stats: {name: 'jackal', 
